...
def dataPreProcessing(data_lake_path: str):
    ...
    try:
        for file_name in os.listdir(os.path.join(data_lake_path,Constants.RAW_STOCKS_FOLDER_PATH)):
            file_path = os.path.join(Constants.RAW_STOCKS_FOLDER_PATH, file_name)
